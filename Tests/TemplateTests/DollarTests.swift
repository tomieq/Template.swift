...
final class DollarTests: XCTestCase {
    func testVariableNotAssigned() throws {
        let template = Template(raw: "$number empty", interpolation: .dollar)
    ...
    func testObjectAssignment() throws {
        ...
        let template = Template(raw: "$number $name", interpolation: .dollar)
    ...
    func testNestAssignment() throws {
        ...
        XCTAssertEqual("welcomei1i2i3 120", template.output)
    }
